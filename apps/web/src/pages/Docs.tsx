      ...
      <nav>
        <div className="nav-inner">
          ...
          <div className="nav-links">
            ...
            <a href="/api/docs" target="_blank" rel="noopener noreferrer">API Reference</a>
        ...
        {mobileOpen && (
          <div className="nav-mobile" role="dialog" aria-label="Mobile navigation">
            ...
            <a href="/api/docs" target="_blank" rel="noopener noreferrer" onClick={() => setMobileOpen(false)}>API Reference</a>

      ...
      whyUs={[
        {
          ...
          body: "Most teams end up with Healthchecks + UptimeRobot + a status page tool — that's three vendors. UptimeCrow does all three from a single dashboard, free for 10 monitors.",
        },
        {

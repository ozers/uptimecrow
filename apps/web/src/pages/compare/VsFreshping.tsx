...
export function VsFreshping() {
  return (
    <CompareLayout
      ...
      whyUs={[
        {
          title: "Generous free tier — 10 monitors forever",
          body: "10 uptime monitors, 3 heartbeat monitors, 1 status page, and 1-minute checks. No trial period. No credit card.",
        },
        {
      ...
      rows={[
        ...
        { feature: "Free tier monitors", us: "10 monitors forever", them: "Was 50 monitors" },

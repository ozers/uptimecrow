...
export function CompareLayout(props: Props) {
  ...
  usePageMeta({
    ...
    description: `Compare UptimeCrow vs ${competitor} side-by-side. Features, pricing, heartbeat monitoring, and status pages. Free plan with 10 monitors, or self-host unlimited.`,
  ...
  return (
    <div className="landing">
      ...
      <section className="final-cta">
        <div className="container">
          <h2>Try {BRAND} free — 10 monitors hosted, or self-host unlimited.</h2>

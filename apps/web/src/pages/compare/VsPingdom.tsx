...
export function VsPingdom() {
  return (
    <CompareLayout
      ...
      subhead="Pingdom charges $15–$250/mo for features UptimeCrow ships on a $0–$80 scale. You get uptime checks, heartbeat monitoring, branded status pages, and automatic incident management — without the Pingdom sticker shock."
      pitch={
        <>
          <p>
      ...
      whyUs={[
        {
          ...
          body: "Pingdom's cheapest plan is $15/mo for 10 monitors. UptimeCrow's free tier gives you 10 monitors at no cost, and the Indie plan ($10/mo) adds a custom domain and API access.",
        },
        {
      ...
      rows={[
        ...
        { feature: "Pro-tier price", us: "$30/mo · 100 monitors", them: "$40–$100/mo" },
        ...
        { feature: "Slack / Discord / webhooks", us: "✓ Built-in", them: "✓ Built-in (extra cost)" },
        ...
        { feature: "API access", us: "Pro plan ($30/mo)", them: "Paid plans" },
      ]}
      whenThem={
        <>
          <p>
